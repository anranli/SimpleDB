...
public class LockManager {
    ...
    public synchronized void block(TransactionId tid, PageId pid) throws TransactionAbortedException {
    ...
    private synchronized boolean deadLock(TransactionId tid, PageId pid) {
    	if (this.getPageLockType(pid) != null){ 
